            ...
            if (this.isOfferAvailable || isOfferAvailable) {
                ...
                if (await this.props.changeStateOffer(this.props.address.documentId, this.props.address.offers, this.props.selectedOffer, "reserved")) {
                    ...
                    if (couponDocumentId !== null) {
                        ...
                        console.log('http://localhost:3000/coupon/' + couponDocumentId)
                        await this.props.sendSms({
                                                     to: '+' + this.props.auth.phoneNumber,
                                                     body: 'Voici le lien vers ton coupon Wom : http://localhost:3000/coupon/' + couponDocumentId
                                                 })
                        return;
                    }
